...
const Movie = ({ movie, viewTrailer }) => {
  ...
  const [cardIsVisibile, setCardIsVisibile] = useState(false);
  ...
  const toggleCardVisibility = (event, state) => {
    setCardIsVisibile(state);
  ...
  return (
    <div className="wrapper">
      <div
        className={"card " + (cardIsVisibile ? "opened" : "")}
        onClick={(e) => toggleCardVisibility(e, true)}
      >
        ...
        <button
          type="button"
          className="close"
          onClick={(e) => toggleCardVisibility(e, false)}
          aria-label="Close"
        >
